...
export default function RootStackNavigator() {
  ...
  return (
    <Stack.Navigator>
      ...
      <Stack.Screen name="PropertyDetail" component={PropertyDetailScreen}options={{ headerTitle: 'Property Detail' }}/>
      <Stack.Screen name="PropertyChat" component={PropertyChatScreen} options={{ headerTitle: 'Property Chat' }}/>
      <Stack.Screen name="Booking" component={BookingScreen}options={{ headerTitle: 'My Bookings' }}/>
